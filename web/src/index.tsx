...
import './styles.scss';
import 'spectre.css'
import { Score, toUnixTimestamp } from './common';
...
function App() {
	const [ scoreData, setScoreData] = useState<Score>(new Score());
    ...
    function getFirstDayOfWeek(d: Date): Date {
        d = new Date(d);
        var day = d.getDay(),
    ...
    function fetchScoreData(url?: string) {
